                ...
                <div className="p-4 mt-16">
                    <div>
                        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <h1 className="text-2xl font-medium">Members Table</h1>
                            <div>
                                <ol className="flex items-center gap-2">
                                    <li>
                                        <a className="text-2xl font-medium">Dashboard /</a>
                                    </li>
                                    <li className="text-2xl font-medium text-[#FF0000]"><a>Members</a></li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div className="relative overflow-x-auto rounded-lg bg-white">
                        <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-5">
                            {filteredMembers.map(member => (
                                <li key={member.id} className="col-span-1 divide-y divide-gray-200 border border-gray-200 rounded-lg bg-white shadow">
                                    ...
                                    <div>
                                        <div className="-mt-px flex divide-x divide-gray-200">
                                            <div className="flex w-0 flex-1 cursor-pointer hover:bg-[#ff0000]">
                                                <a onClick={() => handleDeleteClick(member.id)} className="relative hover:text-white -mr-px inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-bl-lg border border-transparent py-4 text-sm font-semibold text-gray-900">
                                                    Delete
                                                </a>
                                            </div>
                                            <div className="-ml-px flex w-0 flex-1 cursor-pointer hover:bg-gray-100">
                                                <a onClick={() => handleMoreClick(member.id)} className="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-br-lg border border-transparent py-4 text-sm font-semibold text-gray-900">
                                                    More
                                                </a>
                                            </div>
                                        </div>
