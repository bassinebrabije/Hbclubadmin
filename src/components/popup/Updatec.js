                    ...
                    <div className="relative p-4 w-full max-w-3xl max-h-full bg-white rounded-lg shadow-lg z-50">
                        <div className="flex items-center pl-2">
                            <div className="relative pr-2 pb-2 w-36 rounded-full">
                                <img className="h-20 w-20 mx-auto" src={`http://localhost:8000/images/${selectedTrainerImg}`} alt={selectedTrainerImg} />
                            </div>
                            <div className="relative pr-2 w-96 rounded-full">
                                <p className='font-medium'>Trainer </p>
                                <p className='font-medium pl-2'>Full Name: {selectedTrainer}</p>
                            </div>
                            <div className="relative pr-2 pb-2 w-36 rounded-full">
                                <img className="h-20 w-20 mx-auto" src={`http://localhost:8000/images/${selectedMemberImg}`} alt={selectedMemberImg} />
                            </div>
                            <div className="relative pr-2 w-96 rounded-full">
                                <p className='font-medium'>Member </p>
                                <p className='font-medium pl-2'>Full Name: {selectedMember}</p>
                            </div>
                            ...
                            <form className="space-y-4" onSubmit={handleSubmit}>
                                <div className="flex space-x-4">
                                    <div className="flex-1">
                                        <label htmlFor="selectedTrainer" className="block mb-2 text-sm font-medium text-gray-900">Trainer</label>
                                        <input
                                            list="trainers"
                                    ...
                                    <div className="flex-1">
                                        <label htmlFor="selectedMember" className="block mb-2 text-sm font-medium text-gray-900">Member</label>
                                        <input
                                            list="members"
